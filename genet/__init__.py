...
class PlainNet(nn.Module):
    def __init__(
        self, num_classes=None, plainnet_struct=None, no_create=False, **kwargs
    ):
...
def genet_large(pretrained=False, num_classes=1000, root="./GENet_params"):
    ...
    model.module_list = nn.ModuleList(
        [
            ConvKX(3, 32, 3, 2),
            BN(32),
            RELU(32),
    ...
    model.adptive_avg_pool = AdaptiveAvgPool(2560, 1)
...
def genet_small(pretrained=False, num_classes=1000, root="./GENet_params"):
    ...
    model.adptive_avg_pool = AdaptiveAvgPool(1920, 1)
